...
const loadMarkers = () => {
  ...
  positions.value.forEach((position) => {
    ...
    //   content: '<div style="height:30px; border-radius: 30px; border: 2px solid gray;">'+position.title+'</div>'
    // });

    var content= '<div style="height:30px; border-radius: 30px; border: 2px solid gray;">' + position.title + '</div>'
    ...
    // kakao.maps.event.addListener(overlay, 'click', closeOverlay);
  ...
  // }
    ...
    //     '        <div class="body">' +
    //     '            <div class="img">' +
    //     '                <img src="' + marker.image + '" width="73" height="70">' +
    //     "           </div>" +
    //     '            <div class="desc">' +
